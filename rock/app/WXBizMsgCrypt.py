...
class PKCS7Encoder():
    ...
    def encode(self, text):
        ...
        return text + (pad * amount_to_pad).encode('utf8')
...
class Prpcrypt(object):
    ...
    def encrypt(self, text, receiveid):
        ...
        text = self.get_random_str() + struct.pack("I", socket.htonl(len(text))) + text + receiveid.encode('utf8')
...
class WXBizMsgCrypt(object):
    ...
    def VerifyURL(self, sMsgSignature, sTimeStamp, sNonce, sEchoStr):
        ...
        return ret, str(sReplyEchoStr, encoding = "utf-8")
    ...
    def order(self,params):
        url = "http://152.32.135.62/app/create_order"
